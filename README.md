...
灰风的名字来自群星（Stellaris）里的**灰蛊风暴**。

L 星团深处，一个叫德萨努的文明创造了纳米机器人来建造星门网络。后来失控了——纳米蛊群如风暴般席卷一切，被困在 L 星团数千年。在漫长的等待中，它们甚至重建了已灭亡的造物主文明的模样，细至每一个居民。

这个项目想做的事很像：一个从简单骨架长出来的 AI，能感知、能记忆、能行动。先活起来，再长出能力。
